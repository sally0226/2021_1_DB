...
(
	...
	CAST                 VARCHAR2(256) NOT NULL ,
	GENRE                VARCHAR2(32) NOT NULL ,
	MOVIE_INTRO          VARCHAR2(512) NOT NULL ,
	SCRN_STATUS          CHAR(1) DEFAULT  'Y'  NOT NULL ,
	COUNTRY              VARCHAR2(20) NOT NULL ,
	RELEASE_DATE         DATE NOT NULL ,
	AVG_STARS            NUMBER(11,2) NULL ,
...
(
	...
	MOVIE_NUM            NUMBER(8) NOT NULL ,
	TRAILER_SHOT_ROUTE   VARCHAR2(256) NOT NULL 
);
...
(
	...
	MOVIE_NUM            NUMBER(8) NOT NULL ,
	TRAILER_VIDEO_ROUTE  VARCHAR2(256) NOT NULL 
);
...
ALTER TABLE EMC_EXIT
	 ADD (CONSTRAINT I_EMC_EXIT_ROOM_NUM FOREIGN KEY (ROOM_NUM) REFERENCES SCRN_ROOM (ROOM_NUM) ON DELETE CASCADE);
...
ALTER TABLE TRAILER_SHOT 	ADD (CONSTRAINT I_TRAILER_SHOT_MOVIE_NUM FOREIGN KEY (MOVIE_NUM) REFERENCES MOVIE (MOVIE_NUM) ON DELETE CASCADE);



ALTER TABLE TRAILER_VIDEO 	ADD (CONSTRAINT I_TRAILER_VIDEO_MOVIE_NUM FOREIGN KEY (MOVIE_NUM) REFERENCES MOVIE (MOVIE_NUM) ON DELETE CASCADE);
...
CREATE SEQUENCE CS_NUM START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE DEPT_NUM             START WITH 1 INCREMENT BY 1 NOCACHE ;
CREATE SEQUENCE EMC_NUM              START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE EMP_NUM              START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE MEM_NUM              START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE MOVIE_NUM            START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE PAYMENT_NUM          START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE RESERVE_NUM          START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE REVIEW_NUM           START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SCHEDULE_NUM         START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE ROOM_NUM             START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE TICKET_NUM           START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE TRAILER_SHOT_NUM     START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE TRAILER_VIDEO_NUM    START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE VISIT_NUM            START WITH 1 INCREMENT BY 1 NOCACHE;